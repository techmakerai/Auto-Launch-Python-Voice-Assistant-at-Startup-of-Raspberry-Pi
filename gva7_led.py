...
my_api_key = "AIzaSyArPk_e7kLqT2gw5dsYJVHSX4J2gg6VjB4"
    ...
    while True:     
        ...
        with mic as source:            
            ...
            try: 
                ...
                text =  rec.recognize_google(audio, language=slang) #, key="AIzaSyAtjaBtty9GKBMNJ3rZto1dU6bAmywUdP8")   # rec.recognize_wit(audio, key=wit_api_key ) #
                # print(text)
